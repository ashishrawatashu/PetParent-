...
import com.cynoteck.petofy.response.appointmentResponse.GetAppointmentDates;
...
public class DateListAdapter extends RecyclerView.Adapter<com.cynoteck.petofy.adapter.DateListAdapter.MyViewHolder>   {
    ...
    @NonNull
    @Override
    public com.cynoteck.petofy.adapter.DateListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.appoint_date_list, parent, false);
        com.cynoteck.petofy.adapter.DateListAdapter.MyViewHolder vh = new com.cynoteck.petofy.adapter.DateListAdapter.MyViewHolder(v);
        return vh;

    }

    @Override
    public void onBindViewHolder(@NonNull com.cynoteck.petofy.adapter.DateListAdapter.MyViewHolder holder, int position) {
