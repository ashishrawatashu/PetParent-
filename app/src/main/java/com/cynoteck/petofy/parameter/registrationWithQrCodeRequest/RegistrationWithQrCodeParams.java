...
public class RegistrationWithQrCodeParams {
    ...
    {
        return "ClassPojo [lastName = "+lastName+", petDateofBirth = "+petDateofBirth+", otherSizeName = "+otherSizeName+", address = "+address+", petColorId = "+petColorId+", petSizeId = "+petSizeId+", veterinarianUserId = "+veterinarianUserId+", otherBreedName = "+otherBreedName+", petSexId = "+petSexId+", petName = "+petName+", firstName = "+firstName+", phoneNumber = "+phoneNumber+", petAgeId = "+petAgeId+", otherAgeName = "+otherAgeName+", petCategoryId = "+petCategoryId+", otherColorName = "+otherColorName+", petBreedId = "+petBreedId+", email = "+email+"]";
    }
}
