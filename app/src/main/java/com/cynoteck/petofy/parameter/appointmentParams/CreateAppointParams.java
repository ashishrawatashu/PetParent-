...
public class CreateAppointParams {
    ...
    {
        return "ClassPojo [duration = "+duration+", petid = "+petid+", description = "+description+", eventStartTime = "+eventStartTime+", title = "+title+", userId = "+userId+", eventStartDate = "+eventStartDate+", vetId = "+vetId+"]";
    }
}
