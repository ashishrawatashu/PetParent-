...
import com.cynoteck.petofy.response.donationResponse.RequestToNgoModel;
import com.cynoteck.petofy.response.getAppointmentsStatusResponse.User;

import java.util.List;

public class PetDonationList {
    ...
    public String toString() {
        return "ClassPojo[" +
                ...
                ", firstServiceImageUrl=" + firstServiceImageUrl +
                ", secondServiceImageUrl=" + secondServiceImageUrl +
                ", thirdServiceImageUrl=" + thirdServiceImageUrl +
                ", fourthServiceImageUrl=" + fourthServiceImageUrl +
                ...
                ", petSexList=" + petSexList +
                ", petAgeList=" + petAgeList +
                ", petSizeList=" + petSizeList +
                ", petColorList=" + petColorList +
                ...
                ", state=" + state +
                ", role=" + role +
                ", otherBreedName=" + otherBreedName +
                ", otherColorName=" + otherColorName +
                ", otherSizeName=" + otherSizeName +
                ", otherAgeName=" + otherAgeName +
                ", ngoUserId=" + ngoUserId +
                ", ngoList=" + ngoList +
