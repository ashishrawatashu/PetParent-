...
public class ParentDetailsData {
    ...
    @Expose
    private Boolean hasMasterVaccinationSchedule;
    ...
    public Boolean getHasMasterVaccinationSchedule() {
        return hasMasterVaccinationSchedule;
    }

    public void setHasMasterVaccinationSchedule(Boolean hasMasterVaccinationSchedule) {
        this.hasMasterVaccinationSchedule = hasMasterVaccinationSchedule;
    }
    ...
    public void setIsEmailChanged(Boolean isEmailChanged) {
