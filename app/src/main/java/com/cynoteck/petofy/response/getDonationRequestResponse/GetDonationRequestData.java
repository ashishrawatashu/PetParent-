...
public class GetDonationRequestData {
    ...
    @SerializedName("user")
    @Expose
    private GetDonationRequestUser user;
    ...
    @Expose
    private GetDonationRequestRequestToNgoModel requestToNgoModel;
    ...
    public GetDonationRequestUser getUser() {
        return user;
    }

    public void setUser(GetDonationRequestUser user) {
        this.user = user;
    }
    ...
    public GetDonationRequestRequestToNgoModel getRequestToNgoModel() {
        return requestToNgoModel;
    }

    public void setRequestToNgoModel(GetDonationRequestRequestToNgoModel requestToNgoModel) {
