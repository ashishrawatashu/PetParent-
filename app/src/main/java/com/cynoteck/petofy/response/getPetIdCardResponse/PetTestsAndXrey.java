...
import com.cynoteck.petofy.response.FollowUp;
import com.cynoteck.petofy.response.UpdatedByUser;
import com.cynoteck.petofy.response.getXRayReports.TypeOfTest;

public class PetTestsAndXrey {
