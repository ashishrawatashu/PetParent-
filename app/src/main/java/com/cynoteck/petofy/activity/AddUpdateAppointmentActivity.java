...
import com.cynoteck.petofy.adapter.PetListHorizontalAdapter;
...
import com.cynoteck.petofy.parameter.appointmentParams.CreateAppointParams;
import com.cynoteck.petofy.parameter.appointmentParams.CreateAppointRequest;
import com.cynoteck.petofy.parameter.appointmentParams.UpdateAppointmentParams;
        ...
        switch (v.getId()) {
            ...
            case R.id.create_appointment_BT:
                ...
                if (petId.isEmpty()) {
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(com.cynoteck.petofy.activity.AddUpdateAppointmentActivity.this).create();
