...
import com.cynoteck.petofyparents.adapter.ProviderClinicTimingsAdapter;
import com.cynoteck.petofyparents.adapter.ProviderReviewsAdapter;
...
public class VetFullProfileActivity extends AppCompatActivity implements ApiResponse, View.OnClickListener {
    String EncryptId, vet_fee, vet_study , vet_rating , vet_address , vet_name , vetUserId ,vet_image_url , petId , id , type ,petParentString ;
