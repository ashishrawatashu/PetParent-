...
public class AcceptAdoptionFragments extends Fragment implements ApiResponse, DonationClickListener {
    ...
    public void getData()
    {
        ...
        service.get(this, ApiClient.getApiInterface().getAdoptionRequestListAccept(Config.token), "getAdoptionRequestListAccept");
    ...
    public void onResponse(Response arg0, String key) {
        switch (key)
        {
            case "getAdoptionRequestListAccept":
                try {
