...
public class AcceptDonationFragment extends Fragment implements ApiResponse, DonationClickListener {
    ...
    private void getPendingList()
    {
        ...
        service.get(this, ApiClient.getApiInterface().viewPetVaccinationAccepted(Config.token), "get-donation-request-list/1");
    }
        ...
        switch (key) {
            case "get-donation-request-list/1":
                try {
                    ...
                    Log.d("AcceptDonation",""+donationResponseList.toString());
