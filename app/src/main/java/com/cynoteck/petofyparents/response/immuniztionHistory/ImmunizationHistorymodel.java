package com.cynoteck.petofyparents.response.immuniztionHistory;
...
public class ImmunizationHistorymodel {
    ...
    private String createdByNavigation;
    private String followUp;
    private String natureOfVisit;
    private String pet;
    private String updatedByNavigation;
    private String veterinarianUser;
    private ArrayList<String> veterinarianAppointment = null;
    private ArrayList<PetVaccinationDetail> petVaccinationDetail = null;
    ...
    public String getCreatedByNavigation() {
        return createdByNavigation;
    }

    public void setCreatedByNavigation(String createdByNavigation) {
    ...
    public String getUpdatedByNavigation() {
        return updatedByNavigation;
    }

    public void setUpdatedByNavigation(String updatedByNavigation) {
    ...
    public ArrayList<String> getVeterinarianAppointment() {
        return veterinarianAppointment;
    }

    public void setVeterinarianAppointment(ArrayList<String> veterinarianAppointment) {
        this.veterinarianAppointment = veterinarianAppointment;
    }

    public ArrayList<PetVaccinationDetail> getPetVaccinationDetail() {
        return petVaccinationDetail;
    }

    public void setPetVaccinationDetail(ArrayList<PetVaccinationDetail> petVaccinationDetail) {
