...
public class NgoModel_ {
    ...
    private List<String> userPermissionMasterList = null;
    ...
    public List<String> getUserPermissionMasterList() {
        return userPermissionMasterList;
    }

    public void setUserPermissionMasterList(List<String> userPermissionMasterList) {
    ...
    public String toString() {
        return "ClasPojo[" +
                ...
                ", userPermissionMasterList=" + userPermissionMasterList +
                ...
                ", vetRQualification=" + vetRQualification +
                ", onlineAppointmentStatus=" + onlineAppointmentStatus +
                ", isRegisteredPetParent=" + isRegisteredPetParent +
